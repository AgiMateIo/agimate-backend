...
public interface UserOAuthAccountRepository extends JpaRepository<UserOAuthAccount, Long> {
    ...
    List<UserOAuthAccount> findByUserEntity(UserEntity userEntity);
    Optional<UserOAuthAccount> findByUserEntityAndOauthProvider(UserEntity userEntity, OAuthProviderType provider);
