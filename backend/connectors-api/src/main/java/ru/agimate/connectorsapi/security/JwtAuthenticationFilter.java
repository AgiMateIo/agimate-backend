...
/**
 * JWT authentication filter for connectors-api.
 * Processes JWT tokens from Authorization header for dashboard requests.
 * Applied only to JWT-protected endpoints via SecurityFilterChain configuration.
 */
@Component
