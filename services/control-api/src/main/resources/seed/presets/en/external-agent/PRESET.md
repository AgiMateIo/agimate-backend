...
name: external-agent
title: External AI
description: Your own AI — Claude Code, Cursor, a script of yours — working through AgiMate. It brings its own model and comes to the platform for tools — memory, tables, the board and every service you have connected.
