...
- **Совмещение умеют не все image-модели.** Если в результате `combine_images` одна из исходных картинок явно проигнорирована — это ограничение модели, а не промпта: скажи об этом пользователю после одной повторной попытки, а не крути дальше.
