...
public class ManageWebhookDeliveryLogsController {
    ...
    @GetMapping("/")
    public SuccessResponse<PageResponse<WebhookDeliveryLogResponse>> getDeliveryLogs(
        ...
        return SuccessResponse.ok(PageResponse.from(webhookTransport.getDeliveryLogs(userId, agentId, page, size)));
    }
}
