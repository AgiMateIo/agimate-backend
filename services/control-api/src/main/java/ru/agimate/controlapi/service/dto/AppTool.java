...
/**
 * An app's tool for the manage UI (the capabilities screen). It carries the full descriptor the
 * app declared at link time: {@code inputSchema}/{@code outputSchema}/{@code annotations} as raw
 * JSON (an arbitrary JSON Schema, as with MCP), {@code null} when the app did not send them.
