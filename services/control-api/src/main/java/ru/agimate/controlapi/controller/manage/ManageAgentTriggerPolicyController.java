...
import ru.agimate.controlapi.controller.manage.dto.AgentTriggerPolicyResponse;
import ru.agimate.controlapi.controller.manage.dto.CreateAgentTriggerPolicyRequest;
import ru.agimate.controlapi.controller.manage.dto.UpdateAgentTriggerPolicyRequest;
...
public class ManageAgentTriggerPolicyController {
    ...
    public SuccessResponse<Page<AgentTriggerPolicyResponse>> getPolicies(
        ...
        Page<AgentTriggerPolicyResponse> response = agentTriggerPolicyService.getPoliciesByAgent(userId, agentId, page, size)
    ...
    public SuccessResponse<AgentTriggerPolicyResponse> getPolicy(
        ...
        UUID userId = UUID.fromString(userPrincipal.id());
        AgentTriggerPolicy policy = agentTriggerPolicyService.getPolicyById(userId, policyId);
    ...
    public SuccessResponse<Void> deletePolicy(
        ...
        UUID userId = UUID.fromString(userPrincipal.id());
        agentTriggerPolicyService.deletePolicy(userId, policyId);
