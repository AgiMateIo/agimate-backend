...
public record AgentChatMessage(
    ...
    public static AgentChatMessage system(String text) {
        return new AgentChatMessage(Role.SYSTEM, text, false, List.of(), List.of());
    }

    public static AgentChatMessage user(String text) {
        return new AgentChatMessage(Role.USER, text, false, List.of(), List.of());
    }
    ...
    public static AgentChatMessage toolResults(List<ToolResult> results) {
        return new AgentChatMessage(Role.TOOL, null, false, List.of(), results);
    }
