...
class ApiKeyUtilsTest {
    ...
    class GenerateTests {
        ...
        void generate_defaultType_createsValidKey() {
            ...
            assertTrue(generated.fullKey().startsWith("amob"));
        ...
        void generate_keyFormat_isCorrect() {
            ...
            // Type (positions 1-3)
            assertEquals("mob", fullKey.substring(1, 4));
    ...
    class FullWorkflowTests {
        ...
        void fullWorkflow_generateParseVerify() {
            // 1. Generate key
            GeneratedApiKey generated = ApiKeyUtils.generate("mob");
