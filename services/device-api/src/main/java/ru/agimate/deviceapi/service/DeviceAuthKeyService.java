...
import ru.agimate.deviceapi.security.DeviceAuthenticationToken;
import ru.agimate.deviceapi.security.DevicePrincipal;
...
public class DeviceAuthKeyService {
    ...
    public Optional<DeviceAuthKey> validateKey(String apiKey) {
        ...
        Optional<DeviceAuthKey> keyOpt = deviceAuthKeyRepository.findActiveKeyByKeyId(parsedApiKey.keyId());
