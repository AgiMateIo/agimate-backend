...
import ru.agimate.deviceapi.service.ToolDefinitionService;
...
public class ManageToolsController {
    ...
    public SuccessResponse<Map<String, ToolSpecificationResponse>> getTools(
        ...
        return SuccessResponse.ok(toolDefinitionService.getTools(userPubId, connectorCode, identity));
    }
    ...
    public SuccessResponse<ToolSpecificationResponse> getTool(
        ...
        UUID userPubId = UUID.fromString(principal.pubId());
        return SuccessResponse.ok(toolDefinitionService.getTool(userPubId, connectorCode, toolName, identity));
    }
}
