...
- **Ссылка навыка** (`agent_skill_connections`, на связке агент↔навык) — *какой именно* инстанс имеет
  ...
  есть инстанс и он привязан к агенту. **Неудовлетворённый скилл агенту не отдаётся вовсе** — иначе
  его тело обещало бы тулы, которых в контексте нет. Тул-гейт `RunContextService` работает по
