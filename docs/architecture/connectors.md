...
- **Ссылка навыка** (`agent_skill_connections`, на связке агент↔навык) — *какой именно* инстанс имеет
  ...
  есть инстанс и он привязан к агенту; для привязок, сделанных до появления ссылок, действует
  переходный фолбэк «любой инстанс этого кода» — он умрёт вместе с переездом тул-гейта с кода на
  инстанс.
