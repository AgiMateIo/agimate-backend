...
Каждый ран отчёта получает каналы последнего рана разговора, начатого сообщением человека
(`findLatestDialogueRun`): progress и answer, без prompt. Если такого рана нет, `answer =
