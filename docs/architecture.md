...
| am_control_db     | control-api     | `connectors`, `trigger_logs`, `agent_runs`, `tool_call_logs`, `agents`, `agent_tools`, `agent_triggers`, `webhook_delivery_logs`, `platforms`, `integrations`, `agentic_teams` |
